...
$cfg['Servers'][$i]['host'] = '{DATABASE_SERVER_HOSTNAME}';
$cfg['Servers'][$i]['port'] = '{DATABASE_SERVER_PORT}';
$cfg['Servers'][$i]['AllowRoot'] = false;
$cfg['Servers'][$i]['controlhost'] = '{DATABASE_SERVER_HOSTNAME}';
$cfg['Servers'][$i]['controlport'] = '{DATABASE_SERVER_PORT}';
$cfg['Servers'][$i]['controluser'] = '{CONTROL_USER}';
$cfg['Servers'][$i]['controlpass'] = '{CONTROL_USER_PASSWD}';
